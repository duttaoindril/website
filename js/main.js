...
google.maps.event.addDomListener(window, 'load', init);
    ...
    function init() {
        var mapOptions = {
            center: new google.maps.LatLng(37.375823, -121.922018),
            zoom: 17,
            zoomControl: true,
            zoomControlOptions: {
        ...
        var locations = [
['PayPal Town Hall', 'undefined', 'undefined', 'undefined', 'paypal.com', 37.375823, -121.922018, 'https://mapbuildr.com/assets/img/markers/default.png']
        ];
      ...
      var infoWindowVisible = (function () {
           ...
           google.maps.event.addListener(marker, 'click', function() {
               if (infoWindowVisible()) {
                   ...
                   var html= "<div style='color:#000;background-color:#fff;padding:5px;width:150px;'><h4>"+title+"</h4><a href='"+link+"'' >"+web+"<a></div>";
